...
## Enterprise access upgrade

See [`ENTERPRISE_UPGRADE.md`](./ENTERPRISE_UPGRADE.md) for the RBAC hierarchy, client isolation, employee/client management, job assignment history, migration and production security notes.
