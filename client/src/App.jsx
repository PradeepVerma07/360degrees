...
function Login({ onLogin }) {
    ...
    return _jsxs("div", { className: `auth-shell auth-${portal}`, children: [
            ...
            _jsx("main", { className: "auth-panel", children: _jsxs("div", { className: "auth-card", children: [
                        ...
                        mode === 'login' && _jsx(LoginForm, { onLogin: onLogin, onMode: showMode, portal: portal, setPortal: setPortal, portalLocked: portalRoute.locked }),
...
function LoginForm({ onLogin, onMode, portal, setPortal, portalLocked = false }) {
    ...
    return _jsxs("form", { className: "auth-form", onSubmit: submit, children: [
            !portalLocked && _jsx("div", { className: "auth-portal-switcher", role: "tablist", "aria-label": "Login area", children: Object.entries(loginPortalOptions).map(([key, option]) => _jsx("button", { type: "button", role: "tab", "aria-selected": portal === key, className: portal === key ? 'active' : '', onClick: () => setPortal(key), children: option.label }, key)) }),
