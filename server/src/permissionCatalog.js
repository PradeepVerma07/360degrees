export const permissions = [
  ...
  ['chat.view', 'chat', 'view', 'View internal team chat'],
  ['chat.create', 'chat', 'create', 'Create internal chat threads'],
  ['chat.reply', 'chat', 'reply', 'Reply in internal team chat'],
...
export const moduleCatalog = [
  ...
  { id: 'support', label: 'Support Tickets', permissionAny: ['support.view_all', 'support.view_own', 'support.create', 'support.assign'] },
  { id: 'chat', label: 'Team Chat', permissionAny: ['chat.view', 'chat.create', 'chat.reply'] },
